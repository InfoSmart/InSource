...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_ANGRY );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_SCARED );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_PASSIVE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_SUITCASE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_PASSIVE );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_IDLE );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_PHYSGUN );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_PHYSGUN );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_DUEL );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_SMG1 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_SMG1 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_SMG1 );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_PISTOL );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_AR2 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_AR2 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_AR2 );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_MELEE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_MELEE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_MELEE );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_GRENADE );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROSSBOW );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_CROSSBOW );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_CROSSBOW );
	...
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_REVOLVER );
	...
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_FIST );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_FIST );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_FIST );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_CROUCH_FIST );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_CROUCH_FIST );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_JUMP_FIST );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_FIST );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_FIST );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RANGE_ATTACK_FIST );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_GESTURE_RELOAD_FIST );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_SWIM_IDLE_SHOTGUN );

	//////////////////////////////
	// GarrysMOD

	REGISTER_SHARED_ACTIVITY( ACT_GMOD_TAUNT_SALUTE );
	REGISTER_SHARED_ACTIVITY( ACT_GMOD_NOCLIP_LAYER );
	REGISTER_SHARED_ACTIVITY( ACT_GMOD_DEATH );
	REGISTER_SHARED_ACTIVITY( ACT_GMOD_SHOWOFF_DUCK_02 );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_ZOMBIE_01 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_ZOMBIE_02 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_ZOMBIE_03 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_ZOMBIE_04 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_ZOMBIE_05 );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_WALK_ZOMBIE_06 );

	//////////////////////////////
	// ZOMBIE

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_IDLE_ZOMBIE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_ZOMBIE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_RUN_ZOMBIE_FAST );

	REGISTER_SHARED_ACTIVITY( ACT_ZOMBIE_CLIMB_END );
	REGISTER_SHARED_ACTIVITY( ACT_ZOMBIE_CLIMB_START );
	REGISTER_SHARED_ACTIVITY( ACT_ZOMBIE_CLIMB_UP );
	REGISTER_SHARED_ACTIVITY( ACT_ZOMBIE_LEAP_START );
	REGISTER_SHARED_ACTIVITY( ACT_ZOMBIE_LEAPING );

	REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_RANGE_ZOMBIE );
	REGISTER_SHARED_ACTIVITY( ACT_GMOD_GESTURE_RANGE_ZOMBIE_SPECIAL );

	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_ZOMBIE_SLUMP_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_HL2MP_ZOMBIE_SLUMP_RISE );

	REGISTER_SHARED_ACTIVITY( ACT_RUN_ZOMBIE );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_ZOMBIE_FAST );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_ZOMBIE_01 );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_ZOMBIE_02 );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_ZOMBIE_03 );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_ZOMBIE_04 );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_ZOMBIE_05 );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_ZOMBIE_06 );

	//////////////////////////////
	// TERROR - INFECTED

	REGISTER_SHARED_ACTIVITY( ACT_TERROR_ATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_ATTACK_MOVING );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_RAGE_AT_ENEMY );
	
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_IDLE_NEUTRAL );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_IDLE_ALERT );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_WALK_NEUTRAL );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_WALK_INTENSE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_RUN_INTENSE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_JUMP );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_JUMP_OVER_GAP );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_FALL );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_JUMP_LANDING );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_JUMP_LANDING_HARD );

	REGISTER_SHARED_ACTIVITY( ACT_TERROR_IDLE_ACQUIRE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CROUCH_IDLE_NEUTRAL );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CRAWL_RUN );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_CROUCH_RUN_INTENSE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_JUMP_LANDING_NEUTRAL );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_ATTACK_LOW_CONTINUOUSLY );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_LADDER_DISMOUNT );

	REGISTER_SHARED_ACTIVITY( ACT_TERROR_SIT_FROM_STAND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_SIT_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_SIT_TO_STAND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_SIT_TO_STAND_ALERT );

	REGISTER_SHARED_ACTIVITY( ACT_TERROR_DIE_FROM_STAND );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_DIE_WHILE_RUNNING );

	REGISTER_SHARED_ACTIVITY( ACT_EXP_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_EXP_ANGRY );

	//////////////////////////////
	// TERROR - SURVIVAL

	REGISTER_SHARED_ACTIVITY( ACT_TERROR_LEDGE_HANG_FIRM );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_LEDGE_HANG_WEAK );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_LEDGE_HANG_DANGLE );

	REGISTER_SHARED_ACTIVITY( ACT_FALL );

	REGISTER_SHARED_ACTIVITY( ACT_IDLE_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_CROUCHIDLE_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CROUCH_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_JUMP_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_PRIMARYATTACK_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_RELOAD_SMG );

	REGISTER_SHARED_ACTIVITY( ACT_IDLE_CALM_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_CALM_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_CALM_SMG );

	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INJURED_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_WALK_INJURED_SMG );
	REGISTER_SHARED_ACTIVITY( ACT_RUN_INJURED_SMG );

	REGISTER_SHARED_ACTIVITY( ACT_IDLE_INCAP_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_INCAP_TO_STAND );

	REGISTER_SHARED_ACTIVITY( ACT_TERROR_FLINCH );
	REGISTER_SHARED_ACTIVITY( ACT_TERROR_FLINCH_LEDGE );

	REGISTER_SHARED_ACTIVITY( ACT_DIE_INCAP );
	REGISTER_SHARED_ACTIVITY( ACT_DIE_STANDING );

	REGISTER_SHARED_ACTIVITY( ACT_GEST_OVERHERE );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_POINTLEFT );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_POINTLEFT_QUICK );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_GOGOGO );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_HEAD_NO );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_HEAD_NOD );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_COUGH );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_COUGH1 );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_COUGH2 );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_COUGH3 );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_HEAD_DOWN );
	REGISTER_SHARED_ACTIVITY( ACT_GEST_HEAD_YES );
