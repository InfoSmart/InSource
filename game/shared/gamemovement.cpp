...
ConVar cl_viewbob_enabled( "cl_viewbob_enabled", "1", FCVAR_ARCHIVE, "Oscillation Toggle", true, 0, true, 1 );
ConVar cl_viewbob_timer( "cl_viewbob_timer", "5", FCVAR_ARCHIVE, "Speed of Oscillation");
ConVar cl_viewbob_scale( "cl_viewbob_scale", "0.01", FCVAR_ARCHIVE, "Magnitude of Oscillation");
...
{
	#ifdef APOCALYPSE
	if ( testPlayer && testPlayer->GetTeamNumber() == TEAM_INFECTED )
