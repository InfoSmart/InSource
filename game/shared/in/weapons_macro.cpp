...
CREATE_MACHINEGUN( WeaponBizon, bizon, SMG, WEAPON_BIZON );

// AR-15 con Lanzagranadas - weapon_ar15
// http://youtu.be/MhtTHAv0HSc
CREATE_MACHINEGUN( WeaponAR15, ar15, SMG, WEAPON_AR15 );

// M4 con Lanzagranadas - weapon_m4
// http://youtu.be/7wn51LhCqzI
CREATE_MACHINEGUN( WeaponM4, m4, SMG, WEAPON_M4 );

// MP5-K - weapon_mp5
// http://youtu.be/mBwj2PrHRKY
CREATE_MACHINEGUN( WeaponMP5, mp5, SMG, WEAPON_MP5 );

// MR-C - weapon_mrc
// http://es.wikipedia.org/wiki/MR-C
CREATE_MACHINEGUN( WeaponMRC, mrc, SMG, WEAPON_MRC );

// AK47 - weapon_ak47
CREATE_MACHINEGUN( WeaponAK47, ak47, SMG, WEAPON_AK47 );