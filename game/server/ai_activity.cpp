...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_ANGRY );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_SCARED );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_PASSIVE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_SUITCASE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_PASSIVE );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_IDLE );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_PHYSGUN );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_PHYSGUN );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_DUEL );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_SMG1 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_SMG1 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_SMG1 );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_PISTOL );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_AR2 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_AR2 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_AR2 );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_MELEE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_MELEE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_MELEE );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_GRENADE );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROSSBOW );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_CROSSBOW );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_CROSSBOW );
	...
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_REVOLVER );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_FIST );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_FIST );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_FIST );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_CROUCH_FIST );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_CROUCH_FIST );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_JUMP_FIST );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_FIST );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_FIST );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RANGE_ATTACK_FIST );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_GESTURE_RELOAD_FIST );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_SWIM_IDLE_SHOTGUN );

	//////////////////////////////
	// GarrysMOD

	ADD_ACTIVITY_TO_SR( ACT_GMOD_TAUNT_SALUTE );
	ADD_ACTIVITY_TO_SR( ACT_GMOD_NOCLIP_LAYER );
	ADD_ACTIVITY_TO_SR( ACT_GMOD_DEATH );
	ADD_ACTIVITY_TO_SR( ACT_GMOD_SHOWOFF_DUCK_02 );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_ZOMBIE_01 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_ZOMBIE_02 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_ZOMBIE_03 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_ZOMBIE_04 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_ZOMBIE_05 );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_WALK_ZOMBIE_06 );

	//////////////////////////////
	// ZOMBIE

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_IDLE_ZOMBIE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_ZOMBIE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_RUN_ZOMBIE_FAST );

	ADD_ACTIVITY_TO_SR( ACT_ZOMBIE_CLIMB_END );
	ADD_ACTIVITY_TO_SR( ACT_ZOMBIE_CLIMB_START );
	ADD_ACTIVITY_TO_SR( ACT_ZOMBIE_CLIMB_UP );
	ADD_ACTIVITY_TO_SR( ACT_ZOMBIE_LEAP_START );
	ADD_ACTIVITY_TO_SR( ACT_ZOMBIE_LEAPING );

	ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_RANGE_ZOMBIE );
	ADD_ACTIVITY_TO_SR( ACT_GMOD_GESTURE_RANGE_ZOMBIE_SPECIAL );

	ADD_ACTIVITY_TO_SR( ACT_HL2MP_ZOMBIE_SLUMP_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_HL2MP_ZOMBIE_SLUMP_RISE );

	ADD_ACTIVITY_TO_SR( ACT_RUN_ZOMBIE );
	ADD_ACTIVITY_TO_SR( ACT_RUN_ZOMBIE_FAST );
	ADD_ACTIVITY_TO_SR( ACT_WALK_ZOMBIE_01 );
	ADD_ACTIVITY_TO_SR( ACT_WALK_ZOMBIE_02 );
	ADD_ACTIVITY_TO_SR( ACT_WALK_ZOMBIE_03 );
	ADD_ACTIVITY_TO_SR( ACT_WALK_ZOMBIE_04 );
	ADD_ACTIVITY_TO_SR( ACT_WALK_ZOMBIE_05 );
	ADD_ACTIVITY_TO_SR( ACT_WALK_ZOMBIE_06 );

	//////////////////////////////
	// TERROR - INFECTED

	ADD_ACTIVITY_TO_SR( ACT_TERROR_ATTACK );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_ATTACK_MOVING );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_RAGE_AT_ENEMY );
	
	ADD_ACTIVITY_TO_SR( ACT_TERROR_IDLE_NEUTRAL );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_IDLE_ALERT );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_WALK_NEUTRAL );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_WALK_INTENSE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_RUN_INTENSE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_JUMP );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_JUMP_OVER_GAP );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_FALL );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_JUMP_LANDING );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_JUMP_LANDING_HARD );

	ADD_ACTIVITY_TO_SR( ACT_TERROR_IDLE_ACQUIRE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CROUCH_IDLE_NEUTRAL );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CRAWL_RUN );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_CROUCH_RUN_INTENSE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_JUMP_LANDING_NEUTRAL );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_ATTACK_LOW_CONTINUOUSLY );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_LADDER_DISMOUNT );

	ADD_ACTIVITY_TO_SR( ACT_TERROR_SIT_FROM_STAND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_SIT_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_SIT_TO_STAND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_SIT_TO_STAND_ALERT );

	ADD_ACTIVITY_TO_SR( ACT_TERROR_DIE_FROM_STAND );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_DIE_WHILE_RUNNING );

	ADD_ACTIVITY_TO_SR( ACT_EXP_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_EXP_ANGRY );

	//////////////////////////////
	// TERROR - SURVIVAL

	ADD_ACTIVITY_TO_SR( ACT_TERROR_LEDGE_HANG_FIRM );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_LEDGE_HANG_WEAK );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_LEDGE_HANG_DANGLE );

	ADD_ACTIVITY_TO_SR( ACT_FALL );

	ADD_ACTIVITY_TO_SR( ACT_IDLE_SMG );
	ADD_ACTIVITY_TO_SR( ACT_WALK_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RUN_SMG );
	ADD_ACTIVITY_TO_SR( ACT_CROUCHIDLE_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CROUCH_SMG );
	ADD_ACTIVITY_TO_SR( ACT_JUMP_SMG );
	ADD_ACTIVITY_TO_SR( ACT_PRIMARYATTACK_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RELOAD_SMG );

	ADD_ACTIVITY_TO_SR( ACT_IDLE_CALM_SMG );
	ADD_ACTIVITY_TO_SR( ACT_WALK_CALM_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RUN_CALM_SMG );

	ADD_ACTIVITY_TO_SR( ACT_IDLE_INJURED_SMG );
	ADD_ACTIVITY_TO_SR( ACT_WALK_INJURED_SMG );
	ADD_ACTIVITY_TO_SR( ACT_RUN_INJURED_SMG );

	ADD_ACTIVITY_TO_SR( ACT_IDLE_INCAP_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_INCAP_TO_STAND );

	ADD_ACTIVITY_TO_SR( ACT_TERROR_FLINCH );
	ADD_ACTIVITY_TO_SR( ACT_TERROR_FLINCH_LEDGE );

	ADD_ACTIVITY_TO_SR( ACT_DIE_INCAP );
	ADD_ACTIVITY_TO_SR( ACT_DIE_STANDING );

	ADD_ACTIVITY_TO_SR( ACT_GEST_OVERHERE );
	ADD_ACTIVITY_TO_SR( ACT_GEST_POINTLEFT );
	ADD_ACTIVITY_TO_SR( ACT_GEST_POINTLEFT_QUICK );
	ADD_ACTIVITY_TO_SR( ACT_GEST_GOGOGO );
	ADD_ACTIVITY_TO_SR( ACT_GEST_HEAD_NO );
	ADD_ACTIVITY_TO_SR( ACT_GEST_HEAD_NOD );
	ADD_ACTIVITY_TO_SR( ACT_GEST_COUGH );
	ADD_ACTIVITY_TO_SR( ACT_GEST_COUGH1 );
	ADD_ACTIVITY_TO_SR( ACT_GEST_COUGH2 );
	ADD_ACTIVITY_TO_SR( ACT_GEST_COUGH3 );
	ADD_ACTIVITY_TO_SR( ACT_GEST_HEAD_DOWN );
	ADD_ACTIVITY_TO_SR( ACT_GEST_HEAD_YES );
