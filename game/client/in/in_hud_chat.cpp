...
void CHudChat::OnTick()
{
	...
	/*if ( SDKGameRules() && 
		( SDKGameRules()->GetGameState() == ASW_GS_BRIEFING || SDKGameRules()->GetGameState() == ASW_GS_DEBRIEF || SDKGameRules()->GetGameState() == ASW_GS_CAMPAIGNMAP ) )
	{
...
#if 0
	if ( SDKGameRules() && 
		( SDKGameRules()->GetGameState() == ASW_GS_BRIEFING || SDKGameRules()->GetGameState() == ASW_GS_LAUNCHING ) && GetChatHistory() )
	{
